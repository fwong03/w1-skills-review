...
def all_odd(number_list):
    ...
    odds_only = [num for num in number_list if (num % 2 != 0)] 
...
def all_even(number_list):
    ...
    evens_only = [num for num in number_list if (num % 2 == 0)] 
...
def long_words(word_list):
    ...
    four_plus_chars = [word for word in word_list if (len(word) > 4)]

    return four_plus_chars
...
def halvesies(number_list):
    ...
    halved = [float(num)/2 for num in number_list]
